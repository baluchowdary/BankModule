...
/*	Get the bank details by using {bankId}*/
	...
	@GetMapping("/{bankId}")
	public ResponseEntity<Bank> getBankById(@Valid @PathVariable("bankId") long id) {
...
/*Save Bank details*/
	...
	public ResponseEntity<Bank> saveBankDetails(@Valid @RequestBody Bank bank) {
...
/*Update Bank details based on {bankid}*/
	...
	public ResponseEntity<Bank> updateBankDetails(@Valid @PathVariable("bankId") long bankId, @Valid @RequestBody Bank bank) {
...
/*Delete bank based on {id}*/
	...
	public ResponseEntity<HttpStatus> deleteBankDetails(@Valid @PathVariable("bankId") long bankId) {
